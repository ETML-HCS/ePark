...
class PlaceAvailabilityServiceTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        parent::setUp();
        $this->service = new PlaceAvailabilityService();
    }
    ...
    public function test_get_available_places_excludes_inactive_places(): void
    {
        ...
        $result = $this->service->getAvailablePlacesForDate(Carbon::tomorrow());
        // The inactive place should not appear
